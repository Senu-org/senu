export function ReceiveHero() {
  return (
    <div className="text-center space-y-6">
      ...
      <div className="mb-6">
        <h2 className="text-lg font-semibold text-gray-900">Recibir Dinero</h2>
      </div>

      {/* iOS-style title and description */}
      <div className="space-y-3">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">
          Configura tu Método de Recepción
        </h1>
        <p className="text-base text-gray-600 leading-relaxed max-w-sm mx-auto">
          Elige cómo quieres recibir transferencias de dinero de forma segura y conveniente.
        </p>
      </div>
      ...
      <div className="flex justify-center space-x-2">
        ...
        <div className="flex items-center space-x-1 px-3 py-1 bg-purple-100 rounded-full">
          ...
          <span className="text-xs font-medium text-purple-700">Confiable</span>
        </div>
      </div>
    </div>
  );
