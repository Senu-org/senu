      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            ...
            <Link
              href="/payments"
              className="inline-flex items-center px-6 py-3 md:px-8 md:py-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-colors duration-200"
            >
